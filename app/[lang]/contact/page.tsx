...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
	...
	return {
		...
		description:
			dictionary.contactForm?.subtitle || "Contact MSC Apartments for reservations and inquiries about accommodation in Zakopane and Kościelisko",
		keywords: [dictionary.navigation.contact, "MSC Apartments", "Zakopane", "Kościelisko", "rezerwacje", "noclegi", "kontakt"].join(", "),
		authors: [
			{
				name: "MSC Apartments",
