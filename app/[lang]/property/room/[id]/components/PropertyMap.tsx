...
import { Property, Place } from "@/types"
...
export const PropertyMap = memo(
	function PropertyMap({ property, dictionary }: PropertyMapProps) {
		const mapCode = (property.place as Place & { extended?: { mapCode?: string } })?.extended?.mapCode
