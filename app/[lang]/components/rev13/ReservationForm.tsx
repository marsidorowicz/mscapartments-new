...
import { ReservationForProperty } from "./PropertyListNew"
...
const translations: Record<"en" | "pl" | "it" | "de", ITranslation> = {
	...
	it: {
		...
		terms_dialog_content_p1: "Utilizzando questo servizio, accetti i seguenti termini e condizioni. Si prega di leggerli attentamente.",
		terms_dialog_content_p2:
...
function ReservationForm({ id, arrivalDate, departureDate, theme = "light", locale, discountData, offerData, onBack }: ReservationFormProps) {
						...
						<Box
							...
							<Grid container spacing={3}>
								<Grid size={{ xs: 12, sm: 6 }}>
									<Box
										...
										<Typography variant="subtitle2" sx={{ mb: 1 }}>
											{t("guest")} <span style={{ color: "#d32f2f" }}>*</span>
										</Typography>
										<input
											type="text"
											name="firstName"
								...
								<Grid size={{ xs: 12, sm: 6 }}>
									<Box
										...
										<Typography variant="subtitle2" sx={{ mb: 1 }}>
											{t("phone")} <span style={{ color: "#d32f2f" }}>*</span>
										</Typography>
										<input
											type="text"
											name="phone"
							...
							<Box
								...
								<Box sx={{ pl: 3, pr: 3 }}>
									<Collapse in={formData.invoice} timeout="auto" unmountOnExit>
										<Grid container spacing={2} sx={{ mt: 1 }}>
											<Grid size={{ xs: 12, sm: 6 }}>
												<Typography variant="subtitle2" sx={{ mb: 1 }}>
													{t("company_name")} <span style={{ color: "#d32f2f" }}>*</span>
												</Typography>
												<input
													type="text"
													name="companyName"
											...
											<Grid size={{ xs: 12, sm: 6 }}>
												<Typography variant="subtitle2" sx={{ mb: 1 }}>
													{t("street_address")} <span style={{ color: "#d32f2f" }}>*</span>
												</Typography>
												<input
													type="text"
													name="streetAddress"
											...
											<Grid size={{ xs: 12, sm: 6 }}>
												<Typography variant="subtitle2" sx={{ mb: 1 }}>
													{t("postal_code")} <span style={{ color: "#d32f2f" }}>*</span>
												</Typography>
												<input
													type="text"
													name="postalCode"
											...
											<Grid size={{ xs: 12, sm: 6 }}>
												<Typography variant="subtitle2" sx={{ mb: 1 }}>
													{t("country")} <span style={{ color: "#d32f2f" }}>*</span>
												</Typography>
												<input
													type="text"
													name="invoiceCountry"
											...
											<Grid size={{ xs: 12, sm: 6 }}>
												<Typography variant="subtitle2" sx={{ mb: 1 }}>
													{t("tax_number")} <span style={{ color: "#d32f2f" }}>*</span>
												</Typography>
												<input
													type="text"
													name="taxNumber"
								...
								<Box
									...
									<Typography
										...
										{t("accept_terms")} <span style={{ color: "#d32f2f" }}>*</span>
							...
							<Box
								...
								<Box
									...
									{formatCurrency(servicesState?.totalPrice || 0, "PLN")}
								</Box>
								<Box sx={{ flex: 1, minWidth: 0 }}>{renderSubmitButton()}</Box>
							</Box>
						</Box>
					</form>
				</Paper>
